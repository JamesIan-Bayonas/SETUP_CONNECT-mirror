                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 15px 0; line-height: 1.6;">
                                            <strong style="color: #333333; font-size: 15px;">1. Review the Manifestation of Intent (MOI)</strong><br>
                                            <span style="color: #666666; font-size: 14px;">The MOI form is attached to this email. Please print, fill out, and sign it.</span>
                                        </p>
                                        
                                        <!-- Step 2 -->
                                        <p style="margin: 0 0 5px 0; line-height: 1.6;">
                                            <strong style="color: #333333; font-size: 15px;">2. Set Up Your Account</strong><br>
                                        ...
                                        <p style="margin: 0; line-height: 1.6;">
                                            <strong style="color: #333333; font-size: 15px;">3. Submit Your Documents</strong><br>
                                            <span style="color: #666666; font-size: 14px;">Follow the instructions provided by your DOST-PSTO coordinator to submit the completed MOI form.</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
