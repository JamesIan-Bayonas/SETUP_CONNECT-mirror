      ...
      <div>
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6">
            ...
            <div className="flex flex-1 sm:flex-none items-center gap-3">
                <input type="text" placeholder="Search by name, type, cooperator..." className="flex-1 rounded-md border border-gray-300 px-4 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500" />
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">Payslip</td>
                    <td className="px-6 py-4 text-sm text-gray-600">Seth Lawrence Omandam</td>
                    <td className="px-6 py-4 text-sm text-gray-600">Feb 17, 2026</td>
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">Community Tax Certificate (Cedula)</td>
                    <td className="px-6 py-4 text-sm text-gray-600">Kristian Lloyd Pague</td>
                    <td className="px-6 py-4 text-sm text-gray-600">Feb 16, 2026</td>
                    <td className="px-6 py-4 text-sm">
                      <div className="flex items-center gap-4">
                        <button className="text-blue-600 hover:text-blue-800">View</button>
                        <button className="text-green-600 hover:text-green-800">Edit</button>
