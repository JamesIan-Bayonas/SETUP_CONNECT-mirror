...
// --- DUMMY DATA WITH ATTACHMENTS AND MESSAGE BODIES (30 ITEMS) ---
const FAKE_MESSAGES: Message[] = [
  { 
    id: 1, 
    recipient: "Sarah Johnson", 
    subject: "Permit Application Inquiry – Follow-up", 
    date: "2026-02-24 10:30 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "application.pdf", size: "2.4 MB", type: "pdf" },
      { name: "blueprint.jpg", size: "1.8 MB", type: "image" }
    ],
    body: "Hi, I'm following up on the permit application I submitted last week. Could you please let me know if there are any additional requirements or documents needed?"
  },
  { 
    id: 2, 
    ...
    hasAttachments: true,
    attachments: [
      { name: "requirements.docx", size: "856 KB", type: "doc" },
      { name: "budget.xlsx", size: "1.2 MB", type: "spreadsheet" },
      { name: "signed_forms.pdf", size: "3.1 MB", type: "pdf" }
    ],
    body: "I've attached the missing requirements as requested. Please review the updated documents and let me know if you need anything else."
  },
  { 
    id: 3, 
    ...
    body: "We will be performing scheduled maintenance this weekend. The system will be unavailable from Saturday 10 PM to Sunday 2 AM."
  },
  { 
    id: 4, 
    recipient: "Jenni", 
    subject: "UI Design Feedback - Requesting changes", 
    date: "2024-01-16 11:00 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "mockups.fig", size: "5.7 MB", type: "other" }
    ],
    body: "The latest design looks great! Just a few minor changes needed on the home page. The color scheme is perfect but we need to adjust the spacing."
  },
  { 
    id: 5, 
    recipient: "nifer Le", 
    subject: "System Maintenance Notice – Phase 2", 
    date: "2024-01-16 02:20 PM", 
    isRead: true,
    hasAttachments: false,
    body: "Phase 2 of the system maintenance will begin next week. Please ensure all your work is saved and backed up."
  },
  { 
    id: 6, 
    recipient: "ifer Lee", 
    subject: "Project Proposal – Final Review", 
    date: "2024-01-17 09:00 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "proposal.pdf", size: "4.2 MB", type: "pdf" },
      { name: "presentation.pptx", size: "8.1 MB", type: "other" }
    ],
    body: "Please review the final project proposal and let me know your thoughts by Friday. The client is expecting feedback early next week."
  },
  { 
    id: 7, 
    recipient: "Jennr Lee", 
    subject: "New Assignment: Database Schema", 
    date: "2024-01-18 04:30 PM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "schema.sql", size: "245 KB", type: "code" },
      { name: "diagram.pdf", size: "1.2 MB", type: "pdf" }
    ],
    body: "I've assigned you to work on the new database schema design. Check the attachments for requirements and the current diagram."
  },
  { 
    id: 8, 
    recipient: "Jennifer e", 
    subject: "Meeting Reminder: Sprint Planning", 
    date: "2024-01-19 08:00 AM", 
    isRead: true,
    hasAttachments: false,
    body: "Reminder: Sprint planning meeting tomorrow at 10 AM in the conference room. Please come prepared with your updates."
  },
  { 
    id: 9, 
    recipient: "Jeer Lee", 
  ...
  { 
    ...
    date: "2024-01-21 11:45 AM", 
    isRead: false,
    hasAttachments: false,
    body: "Please verify your account to continue using our services. Click the link below to verify your email address."
  },
  { 
    id: 11, 
    recipient: "Jeer Lee", 
    subject: "Inquiry regarding Permit #9920", 
    date: "2024-01-22 03:20 PM", 
    isRead: false,
    hasAttachments: true,
    attachments: [
      { name: "permit_docs.zip", size: "12.5 MB", type: "archive" }
    ],
    body: "I'm following up on permit #9920 that was submitted last month. Can you provide an update on the status?"
  },
  { 
    id: 12, 
    recipient: "Ivan Paul Benedict Intong", 
    subject: "Creating a Design - UI Engagement", 
    date: "2024-01-23 11:44 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "design_system.fig", size: "6.3 MB", type: "other" },
      { name: "assets.zip", size: "15.2 MB", type: "archive" }
    ],
    body: "Let's work on the UI engagement strategy for the new dashboard. I've attached the design system files for reference."
  },
  { 
    id: 13, 
    recipient: "Zein Bernard Aliswag", 
    subject: "Creating Our Project Proposal", 
    date: "2024-01-24 03:00 AM", 
    isRead: false,
    hasAttachments: false,
    body: "I've started drafting the project proposal for the client meeting next week. Let's schedule a time to review it together."
  },
  { 
    id: 14, 
    recipient: "Sarah Johnson", 
    subject: "Updated Contract - Please Sign", 
    date: "2024-01-25 09:15 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "contract_v2.pdf", size: "3.4 MB", type: "pdf" },
      { name: "signature_page.pdf", size: "1.2 MB", type: "pdf" }
    ],
    body: "Please review and sign the updated contract at your earliest convenience. The changes reflect the new terms we discussed."
  },
  { 
    id: 15, 
    recipient: "Michael Brown", 
    subject: "Weekly Report – Sales Dept", 
    date: "2024-01-26 05:00 PM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "sales_q1.xlsx", size: "2.8 MB", type: "spreadsheet" },
      { name: "charts.pptx", size: "5.4 MB", type: "other" }
    ],
    body: "Here's the weekly sales report with Q1 projections. Numbers are looking good this week with a 15% increase."
  },
  { 
    id: 16, 
    recipient: "Jennifer Lee", 
    ...
    hasAttachments: true,
    attachments: [
      { name: "handbook.pdf", size: "4.7 MB", type: "pdf" },
      { name: "welcome.jpg", size: "2.1 MB", type: "image" },
      { name: "forms.docx", size: "956 KB", type: "doc" }
    ],
    body: "Welcome to the team! Here are your onboarding materials to help you get started. Let me know if you have any questions."
  },
  { 
    id: 17, 
    recipient: "Ivan Paul Benedict Intong", 
    subject: "Design Iteration #2", 
    date: "2024-01-28 11:44 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "iteration2.fig", size: "7.8 MB", type: "other" }
    ],
    body: "Here's the second iteration of the design based on your feedback. I've made the changes to the navigation and color scheme."
  },
  { 
    id: 18, 
    recipient: "Zein Bernard Aliswag", 
    subject: "Proposal Draft - Version B", 
    date: "2024-01-29 03:00 AM", 
    isRead: true,
    hasAttachments: false,
    body: "I've updated the proposal with the new requirements from the client. Can you review the changes when you have a chance?"
  },
  { 
    id: 19, 
    recipient: "Alice Wonderland", 
    subject: "Welcome to the Platform", 
    date: "2024-01-30 08:30 AM", 
    isRead: true,
    hasAttachments: false,
    body: "Welcome! We're excited to have you on board. Get started by completing your profile and exploring the features."
  },
  { 
    id: 20, 
    recipient: "Bob Builder", 
    subject: "Maintenance Completed", 
    date: "2024-01-31 12:00 PM", 
    isRead: false,
    hasAttachments: true,
    attachments: [
      { name: "report.pdf", size: "2.3 MB", type: "pdf" }
    ],
    body: "The scheduled maintenance has been completed successfully. All systems are now back online. See attached report for details."
  },
  { 
    id: 21, 
    recipient: "Charlie Day", 
    subject: "Nightman Cometh Schedule", 
    date: "2024-02-01 07:00 PM", 
    isRead: true,
    hasAttachments: false,
    body: "Here's the rehearsal schedule for the upcoming show. Please arrive 15 minutes early to warm up."
  },
  { 
    id: 22, 
    recipient: "Diana Prince", 
    subject: "Security Training Module", 
    date: "2024-02-02 11:00 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "training.mp4", size: "45.2 MB", type: "other" },
      { name: "certificate.pdf", size: "1.5 MB", type: "pdf" }
    ],
    body: "Please complete the new security training module by Friday. The training takes about 30 minutes to complete."
  },
  { 
    id: 23, 
    recipient: "Edward Elric", 
    subject: "Alchemy Project Updates", 
    date: "2024-02-03 09:45 AM", 
    isRead: false,
    hasAttachments: false,
    body: "Latest updates on the alchemy research project. We've made significant progress on the transmutation circle."
  },
  { 
    id: 24, 
    recipient: "Fiona Apple", 
    subject: "Music License Agreement", 
    date: "2024-02-04 02:20 PM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "license.pdf", size: "2.8 MB", type: "pdf" }
    ],
    body: "Please review the attached music license agreement for the upcoming tour. Let me know if you have any questions."
  },
  { 
    id: 25, 
    recipient: "George Miller", 
    subject: "Fury Road Logistics", 
    date: "2024-02-05 04:30 PM", 
    isRead: true,
    hasAttachments: false,
    body: "Logistics plan for the Fury Road production is ready for review. We'll need to confirm vehicle availability by Friday."
  },
  { 
    id: 26, 
    recipient: "Hank Pym", 
    subject: "Particle Research Data", 
    date: "2024-02-06 10:00 AM", 
    isRead: false,
    hasAttachments: true,
    attachments: [
      { name: "experiment_results.xlsx", size: "3.7 MB", type: "spreadsheet" },
      { name: "charts.pdf", size: "4.2 MB", type: "pdf" },
      { name: "data.zip", size: "22.1 MB", type: "archive" }
    ],
    body: "Latest findings from the particle research lab. The results are promising and could lead to a breakthrough."
  },
  { 
    id: 27, 
    recipient: "Iris West", 
    subject: "Article Submission Draft", 
    date: "2024-02-07 01:15 PM", 
    isRead: true,
    hasAttachments: false,
    body: "Here's the draft article for your review. Let me know if you have any feedback or suggestions for improvement."
  },
  { 
    id: 28, 
    recipient: "John Wick", 
    subject: "Supply Order: Continental", 
    date: "2024-02-08 12:45 AM", 
    isRead: true,
    hasAttachments: true,
    attachments: [
      { name: "order_form.pdf", size: "1.9 MB", type: "pdf" }
    ],
    body: "Supply order for the Continental has been processed and should arrive by the end of the week."
  },
  { 
    id: 29, 
    recipient: "Kathy Bates", 
    subject: "Fan Letter - Misery", 
    date: "2024-02-09 03:50 PM", 
    isRead: true,
    hasAttachments: false,
    body: "Thank you for your wonderful performance in Misery. You truly captured the essence of the character."
  },
  { 
    id: 30, 
    recipient: "Leo Messi", 
    subject: "Training Schedule Adjustment", 
    date: "2024-02-10 08:20 AM", 
    isRead: false,
    hasAttachments: true,
    attachments: [
      { name: "new_schedule.pdf", size: "1.2 MB", type: "pdf" }
    ],
        ...
        <div className="max-w-full mx-auto bg-white rounded-xl shadow-sm min-h-[90vh] p-4 md:p-6 flex flex-col">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
              ...
              <button 
                onClick={() => setIsModalOpen(true)}
                className="hidden md:flex items-center gap-2 bg-[#5156E5] hover:bg-[#4348C8] text-white px-6 py-2 rounded-lg font-bold text-sm transition-all"
              >
                <PenSquare size={18} />
                Compose 
              </button>
              ...
              <div className="flex bg-[#F3F4F6] p-1 rounded-lg w-full md:w-auto">
                {(["all", "read", "unread"] as const).map((f) => (
                  <button
                    key={f}
                    onClick={() => setFilter(f)}
                    className={`flex-1 px-3 py-2 md:py-1.5 rounded-md text-xs font-bold transition-all ${
                      filter === f ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700"
                    }`}
                  >
                    {f.charAt(0).toUpperCase() + f.slice(1)}
            ...
            <div className="relative border-t border-gray-100">
                    ...
                    >
                      <div className="flex items-center" onClick={(e) => e.stopPropagation()}>
                        <input 
                          ...
                          checked={isSelected}
                          onChange={() => toggleSelect(msg.id)}
                          className="w-4 h-4 md:w-5 md:h-5 rounded border-gray-300 text-[#5156E5] focus:ring-[#5156E5]" 
                        />
                      </div>
                       ...
                       <div className="grid grid-cols-12 items-start gap-1 md:gap-2">
                        ...
                        <div className="col-span-10 md:col-span-7 flex flex-col">
                          ...
                          <div className="col-span-2 text-right flex flex-col items-end min-w-[60px] md:min-w-[80px]">
                            <div className="text-[9px] md:text-[10px] font-bold text-gray-900 whitespace-nowrap">
                              {formatMessageDate(msg.date)}
                            </div>
              ...
              <div className="absolute bottom-8 right-4 z-20 md:hidden">
                <button 
                  onClick={() => setIsModalOpen(true)}
                  className="bg-[#5156E5] hover:bg-[#4348C8] text-white shadow-xl hover:shadow-2xl transition-all rounded-full w-14 h-14 flex items-center justify-center"
                >
                  <PenSquare size={24} />
                </button>
              </div>
